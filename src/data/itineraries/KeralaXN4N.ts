export const spitiTrekItinerary = {
  ...
  discount: 2000, // Discount applied (final = 14999)
  ...
  itinerary: [
    {
      day: 1,
      title: 'Mumbai To Cochin (Overnight Train)',
      description: 'Overnight departure from Mumbai to Cochin by train.',
      activities: [
        'Board overnight train from Mumbai to Cochin.'
      ],
      meals: ['-'],
    ...
    },
    {
      ...
      description: 'Arrival in Mumbai with happy memories from your trip to God\'s Own Country.',
      activities: [
        'Arrival in Mumbai. Trip concludes.'
      ],
      meals: ['-'],
      accommodation: '-'
    }
