...
export const spitiTrekItinerary = {
  ...
  description: 'Embark on a journey steeped in history, color, and culture as you travel from the bustling city of Mumbai to the Royal heart of Rajasthan.',
  ...
  highlights: [
    'Explore Jaipur – Visit Amber Fort, Hawa Mahal, City Palace & Jantar Mantar',
    ...
    'Discover Jodhpur – Mehrangarh Fort, Umaid Bhavan Palace & Clock Tower Bazaar',
    'Interact with local Spitian communities',
    'Camel Safari in Thar Desert – Ride into golden dunes and enjoy a magical sunset',
    'Experience a peaceful night under the stars',
    'Relax at Gadisar Lake – A tranquil retreat in the heart of the desert'
  ],
  inclusions: [
  ...
  itinerary: [
    ...
    },
    {
      ...
      meals: ['Breakfast', 'Dinner'],
      accommodation: 'Enjoy your stay in Jodhpur'
    },
    {
      day: 6,
