      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center mb-4">
              <img 
                ...
                style={{ filter: "invert(55%) sepia(95%) saturate(1752%) hue-rotate(18deg) brightness(99%) contrast(96%)" }}
              />
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/contact-landing" className="text-gray-300 hover:text-tripvidya-primary transition-colors">
                  Plan Your Trip
                </Link>
              </li>
              <li>
                <Link to="/careers" className="text-gray-300 hover:text-tripvidya-primary transition-colors">
                  Careers
                </Link>
              </li>
            </ul>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-4">
            ...
            <Link to="/backpacking" className="text-gray-400 hover:text-white text-sm">
              Terms of Service
            </Link>
